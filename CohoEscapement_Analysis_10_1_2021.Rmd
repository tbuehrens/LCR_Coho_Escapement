...
accdb.name<-"TWS_Analysis_Only_v9.2.6from2013Forward05302023.accdb"
traphauldata.name<-"TH_dat_05_18_23_w_nflewisabvdam.csv"
frame_file.name<-"Coho_frames_04.05.2022.csv"
RpF_file.name<-"Coho_RpF_02.27.2023_LB.csv"
IMWdata_v2.name<-"IMW_redds_02_12_2023_V2.csv"
IMWdata.name<-"IMW_redds_02.12.2023.csv"


# set data summarization params
years=c(2010:2022)
GRTSdat.date<-"2023-06-26"
assume_Del_Ost_census<-TRUE
UpdateGRTSdata<-FALSE
WriteGRTSdata<-FALSE

#model files
stan_model.file<-"CohoEscapement_Model_2_16_2023.stan"
