...
#=====================
f_year<-2022 #this is the year we want to predict prelim escapement for
results_folder<-"Results_2022-05-23" #trib estimate results to use.
wild_results<-"2010_2021_Coho_TRT_UM_ad.csv"
total_results<-"2010_2021_Coho_TRT_Adults.csv"
#===========================
...
if(!file.exists("results/prelim/m3.RDS")){
  if(!file.exists("models/stan_prelim_model.RDS")){  
    ...
    saveRSE(model,"models/stan_prelim_model.RDS")
  }else{
