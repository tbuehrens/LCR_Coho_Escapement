...
#datasets
frame_file.name<-"Coho_frames_05.02.24_SVP_TB.csv"
RpF_file.name<-"Coho_RpF_06.23.2026_LB_with_Live_Clips_JL.csv"
IMWdata_v2.name<-"IMW_redds_06_27_2026_V2.csv"
IMWdata.name<-"IMW_redds_06_27_2026.csv"



#accdb.name<-"CohoAnalysis_2018_2023.accdb"
#accdb.name<-"CohoAnalysis_2012_2017.accdb"
accdb.name<-"TWS_Analysis_Only_v10.2_2019Through2025_05282026.accdb"
traphauldata.name<-"TH_dat_02_24_26_w_nflewisabvdam.csv"
...
results_name<-"Results_2026-06-27"
```
...
```{r}
#unmarked plot
p<-ggplot(arrange(transform(UM_ad_results,Population=factor(Population,levels=poporder)),Population),aes_(x=as.name("Year"), y=as.name("50%"))) +
  geom_line(size=1)+
  geom_ribbon(aes_(ymin=as.name("2.5%"),ymax=as.name("97.5%")), alpha=0.25) + 
...
#phos plot
p<-ggplot(arrange(transform(pM_results,Population=factor(Population,levels=poporder)),Population), aes_(x=as.name("Year"), y=as.name("50%"))) +
  geom_line(size=1)+
  geom_ribbon(aes_(ymin=as.name("2.5%"),ymax=as.name("97.5%")), alpha=0.25) + 
...
p<-ggplot(arrange(transform(Density_results,Population=factor(Population,levels=poporder)),Population),aes_(x=as.name("Year"), y=as.name("X50."),color=as.name("Origin"))) +
  ...
  # #scale_y_log10()+
  scale_y_log10(limits = c(0.001, 220),
